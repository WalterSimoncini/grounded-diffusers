...
from utils_new.evaluation import evaluate_seg_model
from utils_new import preprocess_mask, get_embeddings, plot_mask
...
loss_name = "log_cosh"
# checkpoints_dir = "/home/lcur0899/save_samples/checkpoints_with_val/"
# checkpoints_dir = "/home/lcur0899/save_samples/trial_checkpoint/"
checkpoints_dir = "/home/lcur0899/save_samples/checkpoint_without_dino_scoring/"
...
plt.title('Training and Validation mIOU scores')
plt.xlabel('Epoch')
plt.ylabel('mIOU')
# plt.savefig('/home/lcur0899/save_samples/test11/training_validation_accuracy.png')
